...
export default function EmergencyScreen() {
  ...
  useEffect(() => {
    Promise.all([fetchHelpContacts(), fetchSupportServices()])
      .then(([c, s]) => {
        setContacts(c);
        setServices(s);
      })
      .catch((e) =>
        setError(e instanceof Error ? e.message : "Failed to load emergency info")
      )
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {services.map((s) => (
          ...
          >
            ...
            <Text style={[styles.action, { color: colors.accent }]}>{s.action}</Text>
          </View>
        ))}
      </ScrollView>
    </SafeAreaView>
